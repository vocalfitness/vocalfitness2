...
// Advanced Apple-style CSS with real animations
const appleStyles = `
  /* Apple Typography Effects */
  .apple-text-shadow {
  ...
  .apple-glow:hover {
    ...
    transition: filter 0.7s cubic-bezier(0.4, 0.0, 0.2, 1);
  }
  ...
  .apple-typography {
    ...
    animation: apple-text-shimmer 3s ease-in-out infinite;
  }
  
  /* Advanced Apple Animations */
  @keyframes apple-text-shimmer {
  ...
  @keyframes apple-border-flow {
    0%, 100% { 
      border-image: linear-gradient(45deg, rgba(59,130,246,0.3), rgba(6,182,212,0.3)) 1;
    }
    50% { 
      border-image: linear-gradient(45deg, rgba(6,182,212,0.6), rgba(59,130,246,0.6)) 1;
    }
  }
  ...
  /* Apple Interactive Classes */
  .apple-glow-pulse {
    animation: apple-glow-pulse 4s ease-in-out infinite;
  }
  ...
  .apple-border-glow {
    ...
    background: linear-gradient(45deg, rgba(255,255,255,0.1), rgba(255,255,255,0.05)) padding-box,
                linear-gradient(45deg, rgba(59,130,246,0.3), rgba(6,182,212,0.3)) border-box;
    animation: apple-border-flow 3s ease-in-out infinite;
  }
  
  .apple-image-enhance:hover {
    filter: contrast(1.3) saturate(1.2) brightness(1.1);
    transition: filter 0.5s cubic-bezier(0.4, 0.0, 0.2, 1);
  }
  
  .apple-overlay-fade:hover {
    opacity: 0.7;
  ...
  /* Typography scaling effect */
  .apple-type-scale {
    animation: apple-scale-in 1s cubic-bezier(0.4, 0.0, 0.2, 1) forwards;
  }
