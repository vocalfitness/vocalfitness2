...
export const PHONEME_U_FOOT = {
   ...
   */
  hotspots: [
    { id: 'alveolar-ridge', x: 39, y: 42, label: 'Alveolar ridge',
    ...
    { id: 'hard-palate', x: 44, y: 47, label: 'Hard palate',
    ...
    { id: 'apex-passive', x: 40, y: 55, label: 'Apex (tongue tip)',
    ...
    { id: 'blade-back', x: 42, y: 57, label: 'Blade (lamina)',
    ...
    { id: 'dorsum-near-close', x: 47, y: 64, label: 'Dorsum',
    ...
    { id: 'lip-rounding', x: 37, y: 67, label: 'Lip rounding',
    ...
    { id: 'velum-raised', x: 52, y: 53, label: 'Velum',
    ...
    { id: 'pharynx-neutral', x: 54, y: 64, label: 'Pharynx',
    ...
    { id: 'larynx-voiced', x: 51, y: 76, label: 'Larynx / Glottis',
