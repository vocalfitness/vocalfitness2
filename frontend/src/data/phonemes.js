...
export const PHONEME_I_FLEECE = {
  ...
  commonWords: [
    { w: 'see',      ipa: '/siː/',      audio: '/api/uploads/elevenlabs/i_fleece_see_mIrm7gNC_1782653317.mp3' },
    { w: 'me',       ipa: '/miː/',      audio: '/api/uploads/elevenlabs/i_fleece_me_mIrm7gNC_1782653318.mp3' },
    { w: 'he',       ipa: '/hiː/',      audio: '/api/uploads/elevenlabs/i_fleece_he_mIrm7gNC_1782653319.mp3' },
    { w: 'we',       ipa: '/wiː/',      audio: '/api/uploads/elevenlabs/i_fleece_we_mIrm7gNC_1782653321.mp3' },
    { w: 'she',      ipa: '/ʃiː/',      audio: '/api/uploads/elevenlabs/i_fleece_she_mIrm7gNC_1782653322.mp3' },
    { w: 'tree',     ipa: '/triː/',     audio: '/api/uploads/elevenlabs/i_fleece_tree_mIrm7gNC_1782653323.mp3' },
    { w: 'three',    ipa: '/θriː/',     audio: '/api/uploads/elevenlabs/i_fleece_three_mIrm7gNC_1782653324.mp3' },
    { w: 'free',     ipa: '/friː/',     audio: '/api/uploads/elevenlabs/i_fleece_free_mIrm7gNC_1782653326.mp3' },
    { w: 'need',     ipa: '/niːd/',     audio: '/api/uploads/elevenlabs/i_fleece_need_mIrm7gNC_1782653327.mp3' },
    { w: 'feel',     ipa: '/fiːl/',     audio: '/api/uploads/elevenlabs/i_fleece_feel_mIrm7gNC_1782653329.mp3' },
    { w: 'week',     ipa: '/wiːk/',     audio: '/api/uploads/elevenlabs/i_fleece_week_mIrm7gNC_1782653330.mp3' },
    { w: 'sleep',    ipa: '/sliːp/',    audio: '/api/uploads/elevenlabs/i_fleece_sleep_mIrm7gNC_1782653331.mp3' },
    { w: 'green',    ipa: '/ɡriːn/',    audio: '/api/uploads/elevenlabs/i_fleece_green_mIrm7gNC_1782653333.mp3' },
    { w: 'street',   ipa: '/striːt/',   audio: '/api/uploads/elevenlabs/i_fleece_street_mIrm7gNC_1782653334.mp3' },
    { w: 'read',     ipa: '/riːd/',     audio: '/api/uploads/elevenlabs/i_fleece_read_mIrm7gNC_1782653335.mp3' },
    { w: 'keep',     ipa: '/kiːp/',     audio: '/api/uploads/elevenlabs/i_fleece_keep_mIrm7gNC_1782653337.mp3' },
    { w: 'agree',    ipa: '/əˈɡriː/',   audio: '/api/uploads/elevenlabs/i_fleece_agree_mIrm7gNC_1782653338.mp3' },
    { w: 'between',  ipa: '/bɪˈtwiːn/', audio: '/api/uploads/elevenlabs/i_fleece_between_mIrm7gNC_1782653339.mp3' },
    { w: 'complete', ipa: '/kəmˈpliːt/',audio: '/api/uploads/elevenlabs/i_fleece_complete_mIrm7gNC_1782653341.mp3' },
    { w: 'machine',  ipa: '/məˈʃiːn/',  audio: '/api/uploads/elevenlabs/i_fleece_machine_mIrm7gNC_1782653342.mp3' },
    { w: 'believe',  ipa: '/bɪˈliːv/',  audio: '/api/uploads/elevenlabs/i_fleece_believe_mIrm7gNC_1782653343.mp3' },
    { w: 'teach',    ipa: '/tiːtʃ/',    audio: '/api/uploads/elevenlabs/i_fleece_teach_mIrm7gNC_1782653345.mp3' },
    { w: 'easy',     ipa: '/ˈiːzi/',    audio: '/api/uploads/elevenlabs/i_fleece_easy_mIrm7gNC_1782653346.mp3' },
    { w: 'people',   ipa: '/ˈpiːpəl/',  audio: '/api/uploads/elevenlabs/i_fleece_people_mIrm7gNC_1782653347.mp3' },
    { w: 'eat',      ipa: '/iːt/',      audio: '/api/uploads/elevenlabs/i_fleece_eat_mIrm7gNC_1782653349.mp3' },
    { w: 'each',     ipa: '/iːtʃ/',     audio: '/api/uploads/elevenlabs/i_fleece_each_mIrm7gNC_1782653350.mp3' },
    { w: 'team',     ipa: '/tiːm/',     audio: '/api/uploads/elevenlabs/i_fleece_team_mIrm7gNC_1782653352.mp3' },
    { w: 'piece',    ipa: '/piːs/',     audio: '/api/uploads/elevenlabs/i_fleece_piece_mIrm7gNC_1782653353.mp3' },
    { w: 'evening',  ipa: '/ˈiːvnɪŋ/',  audio: '/api/uploads/elevenlabs/i_fleece_evening_mIrm7gNC_1782653354.mp3' },
    { w: 'season',   ipa: '/ˈsiːzən/',  audio: '/api/uploads/elevenlabs/i_fleece_season_mIrm7gNC_1782653356.mp3' },
  ],
  ...
  mnemonic: {
    ...
    audio: '/api/uploads/elevenlabs/mnemonic_i_fleece_mIrm7gNC_1782653361.mp3',
  },
  ...
  audio: {
    AmE: {
      isolated: '/api/uploads/elevenlabs/i_fleece_isolated_mIrm7gNC_1782653316.mp3',
      examples: [
        '/api/uploads/elevenlabs/see_the_green_tree_mIrm7gNC_1782653357.mp3',
        '/api/uploads/elevenlabs/she_needs_to_eat_each_week_mIrm7gNC_1782653359.mp3',
        '/api/uploads/elevenlabs/three_sheep_sleep_field_mIrm7gNC_1782653360.mp3',
      ],
    },
    RP: {
      isolated: '/api/uploads/elevenlabs/i_fleece_isolated_mIrm7gNC_1782653316.mp3',
