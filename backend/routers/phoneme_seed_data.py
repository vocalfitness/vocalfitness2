"""
Seed data for the phoneme_cards MongoDB collection.

Contains the initial two phoneme cards (/ʊ/ FOOT and /iː/ FLEECE) that were
previously hardcoded in /app/frontend/src/data/phonemes.js. After seeding, the
DB becomes the source of truth and admins can edit everything through the CMS.
"""
...
SEED_PHONEMES = [PHONEME_U_FOOT, PHONEME_I_FLEECE]
