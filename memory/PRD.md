...
- [x] **Homepage redesign istituzionale B2B/scientifico** (07/02/2026, iter. 9) — Palette unificata WHITE + BLUE medical/scientific (rimosso indigo/violet/cyan). 13 sezioni in EN/IT bilingue: Hero (light, video heroVideo), Credibility Strip, **Trusted by Industry & Academia** (light + LOGO MARQUEE infinito Stripe-style con loghi BASF/Accenture/Dell/BCG/Electrolux + 6 client pills + 10 partner accademici), What VocalFitness Is, **How The Method Works** (light slate-50 + nuovo banner methodVideo + 5 stage cards con icone blue), Who It Is For (4 card light bianche), **Designed to integrate** (blue accent + nuovo integrationVideo), Programmes (SpeakRight 101), CEFR & Outcomes, **Excellence Testimonials** (light, white card, blue dots, harmonized), Selected Contexts, **Steve Dapper** (DARK — l'unica sezione dark intenzionale, + nuovo dapperVideo), dual-path Final CTA. 5 nuovi video corporate posizionati strategicamente. Modali e StickyCTA i18n EN/IT. Navbar a 7 voci.
