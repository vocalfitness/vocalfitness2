...
- [x] **Homepage redesign istituzionale B2B/scientifico** (07/02/2026) — 13 sezioni in EN/IT bilingue agganciate al toggle Navbar: Hero, Credibility Strip, **Trusted by Industry & Academia** (loghi BASF/Accenture/Dell/BCG/Electrolux + 6 client pills + 10 partner accademici: EF Education First, Cambridge, Oxford Alumni, Università di Torino LFSAG, eCampus, MUR/MIUR, DIESSE, H-Farm, Senato della Repubblica, Harvard BS Roma), What VocalFitness Is, How The Method Works, Who It Is For, "Designed to integrate, not to replace", Corporate & Institutional Programmes (SpeakRight 101), CEFR & Outcomes, **Excellence Testimonials** (carousel armonizzato, dark gradient, eyebrow "Voices from the Method"), Selected Contexts, Steve Dapper (institutional dark theme), dual-path Final CTA. Modali e StickyCTA i18n EN/IT. Navbar a 7 voci (rimosso "Aziende"). Coerenza grafica completa tra Trusted/Testimonials/Steve Dapper (palette blue-indigo, typography font-black tracking-tight, eyebrow uppercase tracking-[0.2em]).
